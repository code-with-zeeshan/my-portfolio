// src/components/react/SecretGenerator.tsx
"use client";
        ...
        <div className="space-y-2">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2 dark:border-amber-800 dark:bg-amber-950/30">
            ...
            <ol className="text-xs text-amber-600 dark:text-amber-400 space-y-0.5 list-decimal list-inside">
              <li>
                Your <code className="bg-amber-100 dark:bg-amber-900/50 px-1 rounded">.env</code> file:{" "}
...
export function CronSecretGenerator() {
  return (
    <SecretGenerator
      label="CRON_SECRET"
      description="Use this to protect your scheduled publish endpoint."
...
export function CSRFSecretGenerator() {
  return (
    <SecretGenerator
      label="CSRF_SECRET"
      description="Use this to protect your forms from CSRF attacks."
      envVarName="CSRF_SECRET"
      hintItems={[
        "Vercel → Project → Settings → Environment Variables",
      ]}
    />
