    ...
    <div className="mb-8 md:mb-12 overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      <div className="grid lg:grid-cols-2">
        ...
        >
          ...
          {project.outcome && (
            <p className="text-sm font-semibold text-brand-500 mb-6">
              📈 {project.outcome}
            </p>
          )}
          <div className="flex gap-3">
            <a
              ...
              className="rounded-full bg-zinc-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-600 transition-colors dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-brand-500 dark:hover:text-white"
            >
              View Details
            </a>
            {project.live_url && (
              <a
                ...
                className="rounded-full border border-zinc-300 px-5 py-2.5 text-sm font-medium text-zinc-700 hover:bg-zinc-100 transition-colors dark:border-zinc-700 dark:text-zinc-300 dark:hover:bg-zinc-800"
              >
                Live Demo →
              </a>
            )}
...
export default function DynamicProjects() {
  ...
  // ✅ Only fall back to static data when Supabase is truly unreachable
  ...
  const carouselProjects =
    featuredProjects.length > 0 ? featuredProjects : displayProjects;
  const cardProjects =
    featuredProjects.length > 0 ? featuredProjects : displayProjects;
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            description="Portfolio projects will be showcased here."
          />
        )}
